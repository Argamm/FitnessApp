...
class MineProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            tvEditWeight.text = sharedPreferences.getString(EDT_WEIGHT, getString(R.string.non))
            tvEditTargetWeight.text =
                sharedPreferences.getString(EDT_TARGET_WEIGHT, getString(R.string.notFound))
            tvEditGender.text =
                sharedPreferences.getString(EDT_GENDER, getString(R.string.notFound))
            tvEditHeight.text =
                sharedPreferences.getString(EDT_HEIGHT, getString(R.string.notFound))
